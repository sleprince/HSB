    ...
    class Level : IDisposable
    {
        ...
        private Tile LoadTile(char tileType, int x, int y)
        {
            switch (tileType)
            {
                ...
                case '1':
                    return LoadStartTile1(x, y);

                case '2':
                    return LoadStartTile2(x, y);
        ...
        /// </summary>
        private Tile LoadStartTile1(int x, int y)
        {
            if (Player1 != null)
            ...
            player1 = new Player(this, start1, PlayerIndex.One);
        ...
        /// Instantiates a player, puts him in the level, and remembers where to put him when he is resurrected.
        /// </summary>
        private Tile LoadStartTile2(int x, int y)
        {
            if (Player2 != null)
                throw new NotSupportedException("A level may only have one starting point for each player.");

            start2 = RectangleExtensions.GetBottomCenter(GetBounds(x, y));
            player2 = new Player(this, start2, PlayerIndex.Two);
