...
namespace SchoolFight
{
    ...
    public class PlatformerGame : Microsoft.Xna.Framework.Game
    {
        ...
        private void DrawHud()
        {
            ...
            // Draw health // Steffan - NEW
            float timeHeight = hudFont.MeasureString(timeString).Y;

            level.Player1.MaxHealth = 100;

            //level.Player1.Health = 100; //(level.Player1.Health % level.Player1.MaxHealth);

            level.Player2.MaxHealth = 100;

            level.Player2.Health = 100;

            DrawShadowedString(hudFont, "Player1 Health: " + level.Player1.Health.ToString(), hudLocation + new Vector2(0.0f, timeHeight * 1.2f), Color.Yellow);

            DrawShadowedString(hudFont, "Player2 Health: " + level.Player2.Health.ToString(), hudLocation + new Vector2(0.0f, timeHeight * 2.0f), Color.Yellow);
