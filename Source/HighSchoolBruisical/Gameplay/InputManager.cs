...
namespace HighSchoolBruisical
{
    class InputManager
    {
        ...
        /// </summary>
        public readonly TimeSpan BufferTimeOut = TimeSpan.FromMilliseconds(150);
        ...
        /// </summary>
        public readonly TimeSpan MergeInputTime = TimeSpan.FromMilliseconds(250);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            // NEXT SECTION IS DISABLED TO AVOID UNRESPONSIVENESS
            // DUE TO NONE OF THE ACTIONS BEING MAPPED TO THE DIRECTIONS
